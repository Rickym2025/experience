    ...
    <nav className="fixed top-0 inset-x-0 z-50 bg-black/60 backdrop-blur-xl border-b border-white/10 px-6 py-4">
      <div className="max-w-6xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-2 bg-white/5 border border-white/10 rounded-full px-3 py-1 text-xs">
          ...
          <a href="https://concierge24.rmstudio.app" target="_blank" rel="noopener noreferrer" className="text-stone-400 hover:text-amber-400 px-2 py-0.5 rounded-full hover:bg-white/5 transition">Concierge24</a>
          <a href="https://dentis.rmstudio.app" target="_blank" rel="noopener noreferrer" className="text-stone-400 hover:text-amber-400 px-2 py-0.5 rounded-full hover:bg-white/5 transition">Dentis AI</a>
          <a href="https://drivemotion.rmstudio.app" target="_blank" rel="noopener noreferrer" className="text-stone-400 hover:text-amber-400 px-2 py-0.5 rounded-full hover:bg-white/5 transition">DriveMotion</a>
        </div>
